...
//       debugger
//     // listItems[i].addEventListener('click', listItems.forEach(item =>(){
//     //   item.classList.remove('active');
//     // }))
//     // active.classList.add('active');
// }
...
function toggleimages(dataClass){
    if(dataClass === 'all'){
        ...
        for(let i = 0; i<allimages.length; i++)
          allimages[i].dataset.class.includes(dataClass) ? allimages[i].style.display = 'block' : allimages[i].style.display = 'none';
    }
}
